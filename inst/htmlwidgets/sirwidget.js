HTMLWidgets.widget({
  ...
  renderValue: function(el, x, instance) {
    ...
    var sliders=[
      {"name": "beta", "text":"\u03B2", "value": 1, "min": 0.01/1000, "max": 0.2/1000, "nsteps": 1000},
      {"name": "gamma", "text":"\u03B3", "value": 1, "min": 0.01/1000, "max": 0.1/1000, "nsteps": 1000}
      ];
    var model=mathmodels.sir;
    var states=["S","I","R"];
    var y0=[999,1,0];
    var t0=0,
      tf=250,
    ...
    var data=model(y0,[p.beta,p.gamma],t0,tf,nt);
