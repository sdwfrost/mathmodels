HTMLWidgets.widget({
  ...
  renderValue: function(el, x, instance) {
    ...
    var sliders=[
      {"name": "alpha", "text":"\u03B1", "value": 1, "min": 0.5, "max": 5, "nsteps": 1000},
      {"name": "beta", "text":"\u03B2", "value": 1, "min": 0.5, "max": 5, "nsteps": 1000},
      {"name": "gamma", "text":"\u03B3", "value": 1, "min": 0.5, "max": 5, "nsteps": 1000},
      {"name": "delta", "text":"\u03B4", "value": 1, "min": 0.5, "max": 5, "nsteps": 1000}
      ];
    var model=mathmodels.predprey;
    var states=["X","Y"];
    var y0=[0.5,0.1];
    var t0=0,
      tf=20,
    ...
    var data=model(y0,[p.alpha,p.beta,p.gamma,p.delta],t0,tf,nt);
